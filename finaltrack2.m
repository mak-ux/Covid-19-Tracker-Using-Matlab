...
n=menu('Enter Operations You Want To Perform','1: Press 1.  To See Indias status',...
        ...
        '6: Press 6. To See Age Group Wise Effect In India :',...
        '7: Exit');
    disp('                                                                  ');
...
t=1:length(Casess);
labels = {'Maharastra','TamilNadu','Gujrat','Delhi','Remaining Part Of India'};
figure('units','normalized','outerposition',[0 0 1 1]);
pie(Casess)
legend(labels)
...
res = fitVirusCV19(@getDataWorld,'prn','on','jpg','on','jpres','-r300');
    ...
    case 6
        figure('units','normalized','outerposition',[0 0 1 1]);
        x3=[9 42 33 16];
labels = {'0-20 years','21-40 years age group','41-60 year age group','Above 60'};
pie(x3)
legend(labels)
title('Age Group Wise Covid-19 Effect In India')
